    ...
    <div className="min-h-screen bg-dark-950 text-white font-sans overflow-x-hidden selection:bg-gold selection:text-dark-950">
      ...
      <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})}>
            ...
            <span className="font-title font-bold text-xl md:text-2xl tracking-widest text-gold">IMPERIAL</span>
          </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-12">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-title font-bold text-lg tracking-widest text-gold">IMPERIAL</span>
                </div>
      ...
      <section className="relative h-screen flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-6">
          ...
          >
            BARBEARIA <span className="text-gold-gradient block sm:inline">IMPERIAL</span>
          </motion.h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-dark-500 leading-relaxed font-light">
                Fundada em 2018 com o propósito de redefinir o cuidado pessoal masculino, a Barbearia Imperial combina técnicas tradicionais de barbearia clássica com as maiores tendências internacionais de corte e visagismo.
              </p>
              <p className="text-sm text-dark-500 leading-relaxed font-light">
      ...
      <footer className="bg-dark-950 py-16 border-t border-dark-900">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-12 mt-12 border-t border-dark-900 flex flex-col sm:flex-row items-center justify-between text-xs text-dark-500 gap-4">
          <p>© {new Date().getFullYear()} Barbearia Imperial. Todos os direitos reservados.</p>
          <div className="flex gap-4">
